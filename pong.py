...
def draw(canvas):
    ...
    label1 = myfont1.render("Score " + str(l_score), 1, (255, 0, 0))
    canvas.blit(label1, (50, 20))

    myfont2 = pygame.font.SysFont("Comic Sans MS", 20)
    label2 = myfont2.render("Score " + str(r_score), 1, (255, 0, 0))
